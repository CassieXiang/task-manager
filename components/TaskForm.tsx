    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <input
          ...
          className="flex-1 rounded-lg border border-zinc-300 bg-white px-4 py-3 text-zinc-900 outline-none transition focus:border-zinc-500 focus:ring-2 focus:ring-zinc-200 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:focus:border-zinc-400 dark:focus:ring-zinc-600"
          aria-label="Due date"
        />
        <select
          value={priority}
